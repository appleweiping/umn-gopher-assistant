...
export const VAULT_MAX_PLAINTEXT_BYTES =
  VAULT_MAX_PADDED_PLAINTEXT_BYTES - VAULT_PADDING_BLOCK_BYTES;
export const VAULT_MAX_CIPHERTEXT_BYTES =
  VAULT_MAX_PADDED_PLAINTEXT_BYTES + XCHACHA_TAG_BYTES;
...
export const PERSONAL_VAULT_CONTENT_TYPE =
  "application/vnd.umn-gopher-assistant.personal-vault+json";
